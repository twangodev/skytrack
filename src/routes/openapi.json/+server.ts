...
export const GET: RequestHandler = () => {
	const spec = {
		...
		info: {
			...
			version: '1.0.0',
			description:
				'Endpoints for Hypixel Skyblock market history, served from the market database (bazaar refreshed every 5 minutes, auctions about every 15 minutes) and cached at the edge; there is no auth and no rate limit beyond the CDN. Slugs are the item id lowercased with underscores as hyphens and colons as dots (ENCHANTED_DIAMOND becomes enchanted-diamond). Data comes exclusively from the official Hypixel API. Not affiliated with Hypixel Inc.'
		},
